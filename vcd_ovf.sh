...
#session ID on VCD
SESSIONID=05055206297f4c0d91cb5a702494307d

#local path to ova sources
SOURCE_MASTER='output-vsphere-iso/NAPP_Appliance_0.0.2_master_app.ova'
SOURCE_NODE='output-vsphere-iso/NAPP_Appliance_0.0.2_node_app.ova'
