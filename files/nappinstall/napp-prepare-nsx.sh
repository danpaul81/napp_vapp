...
echo "\e[92mNSX MGR: Set container registry\e[37m"
...
echo "\e[92mNSX MGR: push kubeconfig\e[37m"
...
echo "\e[92mNSX MGR: kubetools\e[37m"
...
echo "\e[92mNSX MGR: set NAPP settings\e[37m"
...
echo "\e[92mNSX MGR: run pre-checks and wait 30sec\e[37m"
...
echo "\e[92mNSX MGR: check status\e[37m"
